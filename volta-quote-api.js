  ...
  modal = modal + '<div style="transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); filter: blur(0px); transform-style: preserve-3d;" class="w-layout-blockcontainer address-modal w-container">';
    ...
    modal = modal + '<div class="w-form"><form id="getquote" class="flex-v for-modal">';
      ...
      if(configQuoteEngine.country == "FR"){
        ...
        modal = modal + '<div class="rightaligned"><div class="container-info"><img src="https://uploads-ssl.webflow.com/644911ac1572f72efba69772/64ed9b2329f3b2cfe8815217_icon%20i.svg" loading="lazy" width="39" alt="" class="itooltipiban"><div class="moreinfo">'+translator("ibanExplanation")+'</div></div>'+translations.sendQuoteModalInputRIB+'</div>';
      } else {
        ...
        modal = modal + '<div class="rightaligned"><div class="container-info"><img src="https://uploads-ssl.webflow.com/644911ac1572f72efba69772/64ed9b2329f3b2cfe8815217_icon%20i.svg" loading="lazy" width="39" alt="" class="itooltipiban"><div class="moreinfo">'+translator("ibanExplanation")+'</div></div>'+translations.sendQuoteModalInputIban+'</div>';
      }      
