            ...
            eligibilityCheck: {
                ...
                add: [
                    ...
                    },
                    {
                        ...
                        insertBefore: 'span.toggle-icon[data-confirm-underwriting]',
                        explanation: 'Bitte beachten Sie, dass Ihre SF-Klasse (Schadenfreiheitsklasse) keinen Einfluss auf die Berechnung Ihrer Versicherungsprämie hat. Wir erfassen diese Information ausschließlich zur Dokumentation der Schadensübersicht.',
...
$("#quoteForm").on("submit", function(e) {
  ...
  if (!emailPattern.test(email)) {
    $("#message").html('<p class="error">Das Format der E-Mail-Adresse ist ungültig. (z.B. name@beispiel.de)</p>');
    $("#loadingOverlay").hide();
    return;
  }
