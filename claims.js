...
const redirectConfig = [
  ...
  { product: "BIKEPOL", claimProcess: "BIKEPOL", Redirect: "https://forms.qover.com/212795616223356?language={{lang}}&variant={{variant}}&email={{email}}&contract_number={{cigarId}}&claims_handler=Qover&ref_country={{country}}" },
