...
function showModal(){
  var htmlToShow = "";
  htmlToShow = htmlToShow + '<h4 class="new-h4_center dark no-margin-t">Welcome!</h4><h4 class="new-h4_center dark no-margin-t light">Are you a business or individual?</h4><div class="div-block-204"><a href="/" data-w-id="1f67638b-ae22-1537-dc86-b9c08705b53c" class="new-cta centered full-width w-button" onclick="forBusiness();"><span class="font-awesome white"></span>Business</a><a href="/individuals" data-w-id="dd0217c7-c223-81c4-68e6-d5f37fdd6605" class="new-cta centered individuals full-width w-button"><span class="font-awesome white"></span>Individual</a></div>';
