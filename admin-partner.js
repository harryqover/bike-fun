...
function findInvoices() {
    ...
    $.ajax(settings).done(function(response) {
        ...
        if (data == "not authorized") {
            ...
            allHTML = allHTML + "<br><br><br><br><h5>Données de facturation</h5><br><p>Qover SA<br>Rue du Commerce 31<br>1000 Bruxelles<br>BE0650.939.878</p>";
            allHTML = allHTML + "<br><br><p><em>* Les factures envoyées à bdx@qover.com ne sont pas visibles directement dans l'interface mais elles seront bien traitées. N'hésitez pas à nous contacter à bdx@qover.com pour toutes questions relatives à la facturation.</em></p>";
            var allHTML = allHTML;
            $(".title-platform, .breadcrumb-here").text("Factures");
            $(".block-in-content-platform").html(allHTML);
            $(".loading").hide();
