...
function showTraining2() {
    ...
    allHTML = allHTML +'<br><br><br><a href="https://storage.googleapis.com/qover-assets/documents/bike/Qover_Manuel%20Utilisation.pdf" target="_blank">Documentation Futurosoft</a>'
    allHTML = allHTML + '</div>';
    $(".block-in-content-platform").html(allHTML);
    $(".hide-when-loading").show();
    $(".loading").hide();
