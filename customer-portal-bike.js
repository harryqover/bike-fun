...
function getNinjaData(cigarId, email) {
    ...
    $.ajax(settings).done(function(response) {
        ...
        console.log("cancelInfo", response.payload.versionInfo.cancelInformation);
...
function getAllInputsChecked (){
    ...
    if(payloadToCancel.lname != "" && payloadToCancel.fname != "" && payloadToCancel.reasonArr.length >0){
        ...
        $(".cancelFormQuestions").attr("style", "transition: opacity 0.5s; opacity:0%;");
        $("#blockStartForm").html(loadingPricesDiv);
        ...
        $.ajax(settings).done(function (response) {
          ...
          console.log(response.payload.actionDone.transKey);
